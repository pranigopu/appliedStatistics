...
- $\displaystyle \lim_{n \rightarrow \infty}} \bar{\mathbb{P}}_n((-\infty, t]) = k$<br>$\displaystyle\lim_{n \rightarrow \infty} \text{Normal}(\mu(\mathbb{P}), \frac{Var(\mathbb{P})}{n})((-\infty, t]) = k$
